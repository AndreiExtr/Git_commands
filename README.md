...
<p style="color: green;">Создается папка dist при сборке Vue.js проекта. Эта папка содержит скомпилированные файлы приложения, которые будут загружены на GitHub Pages.</p>
<p style="color: green;">Прежде чем запушить проект на удаленный репозиторий, надо в файле <code>.gitignore</code> удалить <code>/dist</code>.</p>
